...
class UserVoter extends Voter
{
     ...
     * @return bool
     */
    private function canView(User $edited_user, User $logedin_user): bool
    {
...
//        }
     ...
     * @return bool
     */
    private function canEdit(User $edited_user, User $logedin_user): bool
    {
     ...
     * @return bool
     */
    private function canDelete(User $edited_user, User $logedin_user): bool
    {
        // this assumes that the data object has a getOwner() method
        // to get the entity of the user who owns this data object
        /** @var PersistentCollection $logedin_user_roles */
