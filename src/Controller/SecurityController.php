...
class SecurityController extends AbstractController
{
    ...
    protected function ldapLogin($user, $password, UserPasswordEncoderInterface $passwordEncoder): array
    {
        ...
        try {
            ...
            foreach ($results as $entry) {
                ...
                $ret_arr['dummyPassword'] = $passwordEncoder->encodePassword(new User(), 'dummyPassword');
     ...
     */
    public function login(Request $request, AuthenticationUtils $authUtils, UserPasswordEncoderInterface $passwordEncoder, UserRepository $userRepo): Response
    {
